...
ui <- shinyUI(navbarPage(theme = shinytheme("flatly"), "evolfoRces: Two-allele population genetics simulations",
    tabPanel("Single population",
        sidebarPanel(width=3,
            ...
            sliderInput("Waa_s","Fitness (W) of genotype AA",value=1,min=0.001,max=1),
            sliderInput("Wab_s","Fitness (W) of genotype Aa",value=1,min=0.001,max=1),
            sliderInput("Wbb_s","Fitness (W) of genotype aa",value=1,min=0.001,max=1),
    ...
    tabPanel("Migration",
        sidebarPanel(width = 3, 
            ...
            sliderInput("Wab_m","Fitness (W) of genotype Aa, on ISLAND",value=1,min=0,max=1),
            sliderInput("Wbb_m","Fitness (W) of genotype aa, on ISLAND",value=1,min=0,max=1),
